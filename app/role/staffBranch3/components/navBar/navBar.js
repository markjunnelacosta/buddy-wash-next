    ...
    <div className="side-nav-bar-container">
      <List component="nav">
        <React.Fragment>
          <ListItemButton
            className="button"
            href="/role/staffBranch3/dashBoard"
          >
          ...
          <ListItemButton className="button" href="/role/staffBranch3/reports">
            <ListItemIcon className="button-content">
          ...
          <Dropdown>
            ...
            <DropdownMenu className="dropdown-item" aria-label="Static Actions">
              ...
              <DropdownItem>
                <ListItemButton
                  className="button"
                  href="/role/staffBranch3/manageMobileCustomer"
                >
                  <ListItemText
          ...
          <ListItemButton className="button" href="/role/staffBranch3/machine">
            <ListItemIcon className="button-content">
          ...
          <ListItemButton
            className="button"
            href="/role/staffBranch3/supplyList"
          >
            <ListItemIcon className="button-content">
          ...
          <ListItemButton
            className="button"
            href="/role/staffBranch3/supplyInOut"
          >
            <ListItemIcon className="button-content">
