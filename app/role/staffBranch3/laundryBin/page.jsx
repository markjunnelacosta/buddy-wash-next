...
import AddLaundry from "../../components/forms/BRANCH3/addLaundry/page";
...
const getOrderDetails = async () => {
  try {
    const res = await fetch("/api/BRANCH3/branch3Order", {
      cache: "no-store",
    });
...
const LaundryBin = () => {
  ...
  const updateOrderTimer = async (orderId, date) => {
    ...
    const res = await fetch(`/api/BRANCH3/branch3Order?id=${orderId}`, {
      method: "PATCH",
