...
export default function AddDryerRemarks() {
  ...
  const onClickSave = async () => {
    ...
    const response = await fetch("/api/BRANCH2/branch2DryerRemarks", {
      method: "POST",
      body: JSON.stringify({
        date: date,
        number: number,
  ...
  return (
    <div>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle className="title">New Dryer Remarks</DialogTitle>
        <DialogContent>
