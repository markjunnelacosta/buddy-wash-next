...
const getDryerRemarks = async () => {
  try {
    const res = await fetch("/api/BRANCH3/branch3DryerRemarks", {
      cache: "no-store",
    });
    ...
    return response.branch3DryerRemarks;
  } catch (error) {
              ...
              {filteredDryerRemarks
                ...
                .map((dryerRemarks) => (
                  ...
                  >
                    ...
                    <TableCell align="center">{dryerRemarks.number}</TableCell>
                    <TableCell align="center">{dryerRemarks.remarks}</TableCell>
                  </TableRow>
                ))}
            </tbody>
          </Table>
